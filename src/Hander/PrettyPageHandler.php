...
namespace Hyperf\Whoops\Hander;
...
class PrettyPageHandler extends Handler
{
    ...
    public function __construct(ServerRequestInterface $request)
    {
        ...
        if (class_exists('Symfony\Component\VarDumper\Cloner\VarCloner')) {
            ...
            // Only dump object internals if a custo≠m caster exists.
    ...
    public function handle()
    {
        ...
        $vars = [
            ...
            "tables"      => [
                ...
                "GET"                   => $this->masked($this->request->getQueryParams(), '_GET'),
                "POST"                  => $this->masked($this->request->getParsedBody(), '_POST'),
                "Files"                 => $this->masked(array_map(function($file) {
                    return $file->toArray();
                }, $this->request->getUploadedFiles()), '_FILES'),
                "Cookies"               => $this->masked($this->request->getCookieParams(), '_COOKIE'),
                "Server/Request"        => $this->masked($this->request->getServerParams(), '_SERVER'),
